json.overall do
  ...
  json.avg_grade_climbed @user.avg_sent_grade
...
json.past_month do
  ...
  json.avg_grade_climbed @user.avg_sent_grade(days_ago: 30)
  json.most_frequented_gym @user.most_frequented_gym(days_ago: 30)
